  ...
  return (
    <Card className="overflow-hidden mb-6">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="w-full flex items-center gap-2.5 bg-secondary border-b border-border px-4 md:px-5 py-3 text-left hover:bg-accent transition-colors duration-200"
        aria-expanded={open}
      >
